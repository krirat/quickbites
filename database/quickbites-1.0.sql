...
('One-pot shrimp and tomato pasta', 'Simple one-pot pasta with shrimp, cherry tomatoes, and a buttery white wine sauce.', 35, 'Easy', '1. Sear shrimp in olive oil. Set aside. 2. Sauté garlic, chili, and tomatoes. Deglaze with white wine. 3. Add spaghetti and water. Simmer until pasta is cooked. 4. Add butter and shrimp. Finish and garnish with basil.', 2, 897.0, 'https://images.services.kitchenstories.io/51PrdZKYof0o3Ax0Le3wf26P_0g=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R2708-photo-final-3-4x3.jpg', 'https://images.services.kitchenstories.io/M5YsjEC9TeT50-13CXeNwAF1Imo=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R2708-photo-step-1.jpg', 'https://images.services.kitchenstories.io/u47BtdK7BV9G0_dz_FMyoOe3jSM=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R2708-photo-step-2.jpg', 'https://images.services.kitchenstories.io/embLty_kwFvH_ddRAWkogsvYPG4=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R2708-photo-step-3.jpg', 'https://images.services.kitchenstories.io/a9UJ2rTW_5YXqchAkfqRb0ZrLh8=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R2708-photo-step-4.jpg', NULL, NULL, NULL, NULL),


('Basque burnt cheesecake', 'Crustless Basque cheesecake with a caramelized burnt top and creamy center.', 25, 'Easy', '1. Preheat oven to 200°C/390°F. Grease and line a springform pan with parchment paper. 2. Beat cream cheese and sugar until smooth. 3. Add eggs one at a time, mixing in between. Add cream, vanilla extract, and salt and mix to combine. 4. Sift in flour and fold gently. Pour batter into the pan and bake for approx. 60 min. Let cool before serving.', 8, 651.0, 'https://images.services.kitchenstories.io/Vz-Tauv7o_Hm6DeLt7cNHj6uNNg=/640x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R1965-photo-final-001.jpg', 'https://images.services.kitchenstories.io/3FubiceISi43AIURdmkFiMqeCTs=/640x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R1965-photo-step-001.jpg', 'https://images.services.kitchenstories.io/FsHgSUAUc6lZynPP3Sl3kDjqSmM=/640x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R1965-photo-step-002.jpg', 'https://images.services.kitchenstories.io/WweZaNRzYtZS5GqqRwMl2XlYxDc=/640x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R1965-photo-step-003.jpg', 'https://images.services.kitchenstories.io/3pzCMoXPW1KJ3TVWdhg8Dw8aBw8=/640x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R1965-photo-step-004.jpg', NULL, NULL, NULL, NULL),


('Classic French coq au vin', 'Classic French chicken braised in red wine with aromati vegetables.', 60, 'Medium', '1. Cut chicken into thigh and drumstick pieces. Slice bacon and chop mushrooms, shallots, potatoes, and carrots. 2. Heat oil in a large pan. Season chicken and fry until golden, then remove from the pan. 3. Melt butter in the same pan. Cook bacon, mushrooms, shallots, carrots, and potatoes. Add tomato paste and deglaze with half the red wine. 4. Add remaining red wine, chicken stock, chicken, and herbs. Cover and simmer for approx. 30 min. 5. Stir in cornstarch slurry to thicken the sauce. Season to taste and serve.', 2, 1455.0, 'https://images.services.kitchenstories.io/GHfQjDDxwOK8aJpkHGHzjvtFzGk=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R23-final-photo-4.jpg', 'https://images.services.kitchenstories.io/zPAKG0En2pzVok3n84_mFiiv12Y=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R23-step-photo-_1a.jpg', 'https://images.services.kitchenstories.io/4cHi2XxfvPgaJBwmd-3uBGF1KWw=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R23-step-photo-2a.jpg', 'https://images.services.kitchenstories.io/5KEUJLRf3fyzndfTxda-smDglTo=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R23-step-photo-3a.jpg', 'https://images.services.kitchenstories.io/eBbzNrYJ5Xv3S2IoIz6_V13VeyY=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R23-step-photo-4.jpg', 'https://images.services.kitchenstories.io/SMnbKmAgIR0CJ208dPpEKHczAeA=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R23-step-photo-5.jpg', NULL, NULL, NULL),


('Creamy fish stew with mustard and dill', 'Creamy fish stew flavored with mustard and fresh dill.', 55, 'Medium', '1. Chop leek, garlic, onion, celery, and dill. Cut fish into bite-sized pieces. 2. Coat fish in flour and sear in oil until golden, then set aside. In the same pot sauté garlic, onions, leek, and celery. Deglaze with white wine and add fish stock, allspice, and bay leaf. Simmer, then add cream and mustard. 3. Return fish to the stew and let sit briefly. Stir in dill and season to taste before serving.', 4, 441.0, 'https://images.services.kitchenstories.io/IyB_kRhDQDOMLg-d1PB1nG8E5Hk=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R1617-photo-final-1.jpg', 'https://images.services.kitchenstories.io/Io7gWmvcs8PiLBD_SCiMx_jrMRY=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R1617-photo-step-1.jpg', 'https://images.services.kitchenstories.io/amm-m2sHgJrlFiG9ziJaTU-fDEA=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R1617-photo-step-2.jpg', 'https://images.services.kitchenstories.io/1AdTEVullXLsz6qFp_ot9WzI7fA=/750x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R1617-photo-step-4.jpg', NULL, NULL, NULL, NULL, NULL),
